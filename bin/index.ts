...
program
  .name("eth-cli")
  .description("CLI tool for interacting with Ethereum blockchain")
...
program
  .command("transfer")
  .description("Transfer ETH to the provided address")
  .option("-t, --testnet", "Transfer on the testnet")
  .requiredOption("-a, --address <address>", "Recipient address")
  .requiredOption("-v, --value <value>", "Amount to transfer in ETH")
  .action(async (options: CommandOptions) => {
    try {
...
program
  .command("bridge")
  .description("Interact with ETH bridge")
  .option("-t, --testnet", "Deploy on the testnet")
  .action(async (options: CommandOptions) => {
